<article class="relative isolate flex flex-col gap-8 lg:flex-row border-b pb-12 w-full">
        ...
        <div class="group relative w-full ">
            <h3 class="mt-3 text-2xl font-semibold text-gray-900 group-hover:text-gray-600">
                <a href="{{ route('single-post', [
                    ...
                    {{ $post->title }}
                    <p class="text-gray-500 mb-6 text-sm">Read time: {{ $post->readTime() }} minutes.</p>
                </a>
            </h3>
