...
<div class="flex border-t border-b mb-4 gap-2 py-2 px-4" x-data="{
...
<div class="flex border-t border-b mb-4 gap-2 py-2" x-data="{
    ...
    @else
        <p class="text-sm text-gray-600 mt-1">Likes:</p>
    @endif
    <p x-text="likesCount" class="text-sm text-gray-600 mt-1"></p>
</div>
