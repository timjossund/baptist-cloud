            ...
            <div class="bg-white sm:py-12 mx-auto px-6 lg:px-8 rounded-lg shadow-sm sm:rounded-lg">
                ...
                <div class="flex flex-col lg:flex-row gap-8 w-full max-w-6xl mx-auto items-start">
                    ...
                    <div class="w-full lg:w-2/3">
                        <form action="/post/create-post" method="POST" enctype="multipart/form-data" class="w-full flex flex-col gap-4">
                            @csrf
                            {{-- Post Image --}}
                            <div>
                            ...
                            @endif
                            {{-- Post Submit --}}
                            <x-primary-button class="text-white max-w-52 flex justify-center text-center py-2 rounded-lg mt-2" type="submit">Save Draft</x-primary-button>
                        </form>
                    </div>
