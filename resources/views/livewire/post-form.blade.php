<form wire:submit="store" class="m-auto w-full max-w-6xl flex flex-col gap-4">
    ...
    <div class="relative">
        ...
        @endif
        <x-input-label class="block mb-2" for="image">Featured Image:<span class="text-sm text-gray-500"> This will be cropped to a 16:9 ratio. Please note: If your network is slow, you may not see the image until it has finished loading.</span></x-input-label>
