        ...
        <div class="bg-white py-6 mx-auto px-6 lg:px-8 rounded-lg shadow-sm sm:rounded-lg flex flex-col ">
            <div class="w-full rounded-lg shadow-sm sm:rounded-lg flex flex-col justify-start items-start">
                <div class="w-full mt-10">
                    <h2>Report This Audio Post: {{ $sermon->title }}</h2>
                    <p>This form will submit your name and email and your report.</p>
                    <form action="/report-sermon/{{ $sermon->id }}" method="post" class="mt-4 flex flex-col gap-4">
                        @csrf
                        ...
                        <input type="hidden" name="reporter_email" id="reporter_email"
                        ...
                        <div class="flex justify-between gap-4">
                            ...
                            <a href="{{ url()->previous() }}"
                                class="cursor-pointer h-full flex justify-center items-center">Cancel Report</a>
                        </div>
                    </form>
                </div>
            </div>
