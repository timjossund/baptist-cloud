<x-app-layout>
    <section class="container mx-auto px-6 py-8 flex justify-center" x-data="{publish: false}">
        <div class="max-w-7xl mx-auto px-5 w-full">
            <div class="bg-white sm:py-12 mx-auto px-6 lg:px-8 rounded-lg shadow-sm sm:rounded-lg relative">
                <div class="flex justify-between items-center max-w-6xl mx-auto mb-8">
                    <h2 class="text-4xl font-bold">Publish Your Post</h2>
                ...
                <div class="flex flex-col lg:flex-row gap-8 w-full max-w-6xl mx-auto items-start">
                    ...
                    <div class="w-full lg:w-2/3">
                        <form :action="publish ? '/post/{{ $post->slug }}/publish' : '/post/{{ $post->slug }}'" method="post" enctype="multipart/form-data" class="w-full flex flex-col gap-4">
                            @csrf
                            @method('patch')
                            ...
                            <div class="flex gap-4 items-center justify-between mt-2">
                                ...
                                <a href="{{ route('public-profile', $post->user) }}" class="text-red-500 hover:underline text-sm font-medium">Cancel Edit</a>
                            </div>
