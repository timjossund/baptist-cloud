<x-app-layout>
    <x-guest-layout>
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                <x-input-label class="block mb-2" for="avatar">Add Your Avatar (optional)</x-input-label>
            ...
            <div class="mt-4">
                <x-input-label for="bio" :value="__('Position  (optional)')" />
                <x-text-input id="bio" name="bio" type="text" class="mt-1 block w-full" :value="old('bio')" autocomplete="bio" />
